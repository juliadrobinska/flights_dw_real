...
Overview
This project demonstrates the design and analysis of a relational data warehouse built on flight operations data. The goal was to model flight data using a clean staging → core architecture, validate data quality and integrity, and perform analytical queries focused on delays, cancellations, and seasonality.
...
Tables
	•	staging.flights_raw Raw flight-level data used as the ingestion layer.
